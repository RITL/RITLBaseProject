 ...
 */
- (void)ritl_scrollViewDidScroll:(CGPoint)contentOffSet;
 ...
 */
- (void)ritl_scrollViewWillEndDragging:(CGPoint)conentOffSet;
 ...
 */
-(void)ritl_scrollViewDidEndDecelerating:(CGPoint)conetntOffSet;
