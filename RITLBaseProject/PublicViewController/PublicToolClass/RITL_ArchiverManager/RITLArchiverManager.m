...
{
    //拼接路径文件
    NSString * path = [[self __defaultFullArchiverPath] stringByAppendingPathComponent:document];
...
/// 完整的路径
- (NSString *)__defaultFullArchiverPath
{
    //
    NSString * defaultArchiverPath = [self __defaultArchiverPath];
...
/// 默认的保存路径
- (NSString *)__defaultArchiverPath
{
    return [[self __documentPath] stringByAppendingPathComponent:RITLArchiverFolderName];
}
